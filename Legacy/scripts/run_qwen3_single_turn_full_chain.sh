...
bash scripts/run_gpu_queue.sh \
  ...
  configs/single_turn_pool/qwen3_1p7b_gpqa_single_turn_pool_thinking_off.yaml \
  configs/single_turn_pool/qwen3_1p7b_gsm8k_single_turn_pool_thinking_off.yaml \
  configs/single_turn_pool/qwen3_1p7b_mmlu_single_turn_pool_thinking_off.yaml \
  configs/single_turn_pool/qwen3_1p7b_aime_single_turn_pool_thinking_off.yaml \
